                    ...
                    if (user) {
                        ...
                        if (attendance) {
                            ...
                            if (shiftEnd < nowTime) {
                                ...
                                console.log(`Employee ${ac.name} is about to go out of the office`);
                            } else {
                                // Active shift
                                ...
                                // }
                                if (status === STATUS.WORKING) {
                                    console.log(`Employee ${ac.name} is WORKING, processing break-in`);
                                    try {
                                        await biometricBreakIn(attendanceId, breaks, totalBreak);
                                    ...
                                    console.log(`Employee ${ac.name} is ON_BREAK, processing break-out`);
                                    try {
                                        await biometricBreakOut(attendanceId, breaks);
