...
class Announcement {
    ...
    static async create(announcementData) {
        ...
        if (announcementData.expiresAt) announcementData.expiresAt = new Date(announcementData.expiresAt);
        if (announcementData.approvedAt) announcementData.approvedAt = new Date(announcementData.approvedAt);
        if (announcementData.dateTime) announcementData.dateTime = new Date(announcementData.dateTime);
