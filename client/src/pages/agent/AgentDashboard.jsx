    ...
    const FileAttachment = ({ file, onDownload, onView }) => {
      ...
      const AnnouncementCard = ({ 
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    <div className="flex items-center gap-4">
                      ...
                      <button
                        ...
                        title={isLiked ? "You already liked this" : "Like this announcement"}
                      >
                        <Heart 
                          className={`w-4 h-4 ${isLiked ? 'text-red-500 fill-current' : 'text-gray-500 hover:text-red-500'}`} 
        ...
        const AgentDashboard = () => {
          ...
          const [announcementDetailModal, setAnnouncementDetailModal] = useState({ isOpen: false, announcement: null });
          ...
          useEffect(() => {
            const initializeUserData = () => {
              try {
                ...
                console.log("🔑 Initializing user data:", { userId, userName, employeeId, department });
          ...
          const handleTogglePin = async (announcement) => {
            try {
              ...
              switch (department) {
                case "Accounting": departmentAnnouncements = accounting; break;
                case "Compliance": departmentAnnouncements = compliance; break;
                case "Technical": departmentAnnouncements = technical; break;
                case "HR & Admin": departmentAnnouncements = hr; break;
                default: departmentAnnouncements = hr;
              }
          ...
          // Fetch announcements - UPDATED: Remove status filtering
          const fetchAnnouncements = async () => {
            try {
              ...
              // UPDATED: Show all announcements except Cancelled
              const activeAnnouncements = response.data
                .filter(a => a.status !== "Cancelled") // Only filter out cancelled announcements
                .map(announcement => ({
                  ...announcement,
                  ...
                  acknowledgements: Array.isArray(announcement.acknowledgements) ? announcement.acknowledgements : []
                }))
                .sort((a, b) => {
                  if (a.isPinned && !b.isPinned) return -1;
                  if (!a.isPinned && b.isPinned) return 1;
          ...
          const categorizeAnnouncements = (announcements) => {
            ...
            announcements.forEach(announcement => {
              ...
              switch (department) {
                case "Accounting": accounting.push(announcement); break;
                case "Compliance": compliance.push(announcement); break;
                case "Technical": technical.push(announcement); break;
                case "HR & Admin": hr.push(announcement); break;
                default: hr.push(announcement);
              }
            });
          ...
          return (
            <div>
              ...
              <AnnouncementDetailModal
                ...
                pinnedCount={getPinnedCountByDepartment} // UPDATED: Pass function instead of count
                maxPinnedLimit={MAX_PINNED_PER_DEPARTMENT} // UPDATED: Use per-department limit
                onLike={handleLike}
                hasLiked={hasLiked}
              ...
              {showPinLimitToast && (
                <div className="fixed top-4 right-4 z-[10000] bg-yellow-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-3 animate-in slide-in-from-right duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90">You can only pin up to {MAX_PINNED_PER_DEPARTMENT} announcements per department.</p>
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col lg:flex-row gap-2 sm:gap-4 p-1 lg:p-1">
                <div className="flex-1 min-w-0">
                  <img className="w-full h-24 xs:h-28 sm:h-32 md:h-40 lg:h-48 object-cover rounded-xl sm:rounded-2xl shadow-md" src={telexcover} alt="Dashboard Cover" />
                        ...
                        <div className="mb-6 sm:mb-8">
                          <div className="flex items-center justify-between gap-2 sm:gap-4 mb-3 sm:mb-4">
                            ...
                            <div className="flex items-center gap-3">
                              {/* UPDATED: Show per-department limit */}
                        ...
                        {isLoadingAnnouncements ? (
                          ...
                          <div className="space-y-8">
                            <DepartmentAnnouncementSection
                              ...
                              onTogglePin={handleTogglePin}
                              canPinMore={canPinMoreInDepartment(technical)} // UPDATED: Use department-specific check
                            ...
                            <DepartmentAnnouncementSection
                              ...
                              onFileView={handleFileView}
                              onTogglePin={handleTogglePin}
                              canPinMore={canPinMoreInDepartment(compliance)} // UPDATED: Use department-specific check
                            ...
                            <DepartmentAnnouncementSection
                              ...
                              onFileView={handleFileView}
                              onTogglePin={handleTogglePin}
                              canPinMore={canPinMoreInDepartment(accounting)} // UPDATED: Use department-specific check
                            ...
                            <DepartmentAnnouncementSection
                              ...
                              onFileView={handleFileView}
                              onTogglePin={handleTogglePin}
                              canPinMore={canPinMoreInDepartment(hr)} // UPDATED: Use department-specific check
                          ...
                          <div className="text-center py-8">
                            ...
                            <h4 className="text-lg font-semibold text-gray-600 mb-2">No Announcements</h4>
                            <p className="text-sm text-gray-500">There are no active announcements at the moment.</p>
                          </div>
                        )}
                        ...
                        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200/60">
                          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
                            ...
                            <div className="text-xs sm:text-sm text-gray-500">
                              {/* UPDATED: Show per-department pinning info */}
