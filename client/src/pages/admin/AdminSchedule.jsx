  ...
  const [data, setData] = useState([
    {
      ...
      timeIn: "8:00 A.M.",
      timeOut: "5:00 P.M.",
      notes: "Prepared monthly financial report",
      image:
    ...
    },
    {
      ...
      timeIn: "9:00 A.M.",
      timeOut: "6:00 P.M.",
      notes: "Handled office procurement",
      image:
    ...
    <div>
      ...
      <section className="flex flex-col mb-4">
        <div className="flex items-center justify-between">
          <div>
            <h2>Admin Schedule Logs</h2>
            <p className="text-light">All employee schedules across departments.</p>
          </div>
        </div>
      </section>
