const WarningDeletion = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center h-full w-full">
      ...
      <div className="mt-10">
        <h3 className="font-bold text-xl mb-2">Warning Irreversible Action</h3>
        <p className="text-lg mb-6">
          You are about to{" "}
          <span className="font-semibold">delete this shift schedule(s)</span>.
...
export default WarningDeletion;
