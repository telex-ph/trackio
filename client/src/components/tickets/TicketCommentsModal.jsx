...
  formatDate,
  ticketStatus,
  onCommentUpdate, // New prop for updating a comment
}) => {
  
...
  
  // State for editing
  const [isEditing, setIsEditing] = useState(null); // stores the $id of the comment being edited
...
                                <div className="flex items-center gap-2">
                                  {isCurrentUser && canEdit && !isCurrentCommentEditing && (
                                    <button
                                      type="button"
