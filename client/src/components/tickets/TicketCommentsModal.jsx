import { X, MessageSquare, Clock, Bold, Italic, Underline, Image as ImageIcon, Lock, Edit2, Save, Send, Star } from "lucide-react";
...
const parseConfirmationComment = (commentText) => {
  ...
  if (match) {
    return {
      ...
      feedback: match[3] === 'N/A' || match[3] === 'No feedback provided.' ? null : match[3].trim(),
    };
  }
                          ...
                          <div className="space-y-3">
                            <div className="border-2 border-gray-200 rounded-lg bg-white focus-within:ring-2 focus-within:ring-[#a10000] focus-within:border-transparent transition-all">
                              <div className="flex items-center gap-2 px-3 py-2 border-b border-gray-200">
                                ...
                                <button type="button" className="p-1 hover:bg-gray-100 rounded transition-colors" title="Add image"><ImageIcon className="w-4 h-4 text-gray-600" /></button>
                              </div>
                              <textarea
                                rows="4"
                              ...
                              {isCurrentCommentEditing ? (
                                <div className="pt-2 space-y-3">
                                  ...
                                  <div className="flex justify-end gap-2">
                                    ...
                                    >
                                      {isUpdatingComment ? <Spinner size="sm" /> : <Save className="w-4 h-4" />}
                                      Save Changes
                                    </button>
                                  </div>
                                </div>
                                ...
                                <div className="pt-2 p-3 bg-white border border-yellow-200 rounded-lg shadow-inner space-y-3">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                                        ...
                                        <StarRatingDisplay rating={confirmationData.rating} />
                                    </div>
                                    ...
                                    <div className="pt-1">
                                        ...
                                        <p className="text-sm text-gray-600 italic whitespace-pre-wrap break-words">
                                            {confirmationData.feedback || <span className="text-gray-400">No specific feedback provided.</span>}
                                        </p>
                                    </div>
                                </div>
                              ) : (
