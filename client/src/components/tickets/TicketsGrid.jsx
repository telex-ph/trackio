...
        if (isClosed) {
          const resolutionDate = params.data.resolution_time 
            ? new Date(params.data.resolution_time).toLocaleString("en-US", {
                month: "short", day: "2-digit", year: "numeric",
                hour: "2-digit", minute: "2-digit", hour12: true,
              })
            : "";
          const durationText = params.data.duration || "N/A";
...
              </div>
              <div className="text-sm font-semibold text-green-600 mt-1 flex items-center gap-1">
                <span>✓</span>
                <span>Resolved</span>
              </div>
            </div>
...
        // --- BAGONG LOGIC PARA SA ACTIVE/PAUSED ---
        const calculatedResolutionTime = getResolutionDeadline(
          params.data.$createdAt, // Galing sa DB
          params.data.severity    // Galing sa DB
        );
...
    },
    
    // --- BINAGO: Date Created Column ---
    {
      headerName: "Date Created",
      field: "$createdAt", // Pinalitan ng "$createdAt" based sa image mo
      flex: 1.5,
      cellRenderer: (params) => {
        if (!params.value) {
          return (
